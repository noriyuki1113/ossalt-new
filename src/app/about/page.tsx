    ...
    <>
      ...
      <main className="wrap page">
        ...
        <div className="prose">
          ...
          <p>{"海外の同種サービスは数多くありますが、多くは英語圏の利用を前提としています。日本では、ライセンス表記の意味、社内稟議に必要な情報、「誰が運用するのか」という現実的な論点が異なります。"}
            {"そこで、日本語の説明と、判断に必要な数値（ライセンス・セキュリティ評価・更新状況）を並べて確認できる場所として作りました。"}</p>
          ...
          <p>{"数値は日次の自動処理で更新しています。データの更新日時は各ページ下部に表示されます。現在の収録数は"}{meta.tool_count}件、うちセキュリティ評価を取得できているものは
            {meta.scored_count}{"件です。取得できていないものは「未評価」と表示し、推測値では埋めていません。"}</p>
          ...
          <ul>
            ...
            <li>
              <strong>限界を書く。</strong>{"健全度スコアは規模の大きいプロジェクトほど有利になる指標です。その性質を各所に明記しています。"}</li>
          </ul>
