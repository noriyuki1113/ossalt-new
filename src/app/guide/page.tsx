    ...
    <>
      ...
      <main className="wrap page">
        ...
        <div className="prose">
          ...
          <p>{"健全度スコアは、スター・フォーク・コントリビュータ・ウォッチャー・更新の新しさの5項目から算出した、プロジェクトの「勢い」の目安です。内訳と算出式はツール詳細ページの「健全度」パネルで確認できます。"}
            {"スターやフォークなど、それぞれの数字の意味は"}<Link href="/blog/how-to-read-github/">GitHubの見方</Link>{"の記事で解説しています。"}</p>
          ...
          <p>{"この3点と、公開されているセキュリティアドバイザリの件数は、"}<Link href="/tools/">各ツールのページ</Link>{"のセキュリティ欄にも表示しています。自分で確認する手間を減らしたい場合はそちらも参照してください。"}</p>
